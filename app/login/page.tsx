...
import {Chrome, Clock3, Github, LockKeyhole} from 'lucide-react';
...
export default function Login(){
  ...
  async function oauth(provider:'google'|'github'){
    ...
    try{
      ...
      if(error){setErr(error.message);setOauthBusy(null)}
    }catch(e){setErr(e instanceof Error?e.message:'Authentication is unavailable.');setOauthBusy(null)}
  }
