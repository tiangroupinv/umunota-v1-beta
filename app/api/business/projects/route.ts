...
const milestone=z.object({title:z.string().min(3).max(120),description:z.string().max(1000).optional().default(''),startAt:z.string().datetime(),dueAt:z.string().datetime(),payPerRunnerRwf:z.number().int().min(500)});
