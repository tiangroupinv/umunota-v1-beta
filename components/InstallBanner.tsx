...
export default function InstallBanner(){
 ...
 useEffect(()=>{
  ...
  if(mobile&&!standalone&&sessionStorage.getItem('umunota-install-dismissed')!=='1')setVisible(true);
  const handler=(e:Event)=>{e.preventDefault();setPromptEvent(e as InstallPromptEvent);setVisible(true)};
